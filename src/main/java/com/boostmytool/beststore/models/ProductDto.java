...
public class ProductDto {
    ...
    public @Size(min = 10, message = "the description should be at last 10 characters") @Size(max = 200, message = "the description cannot exceed 200 characters") String getDescription() {
        return description;
    }

    public void setDescription(@Size(min = 10, message = "the description should be at last 10 characters") @Size(max = 200, message = "the description cannot exceed 200 characters") String description) {
